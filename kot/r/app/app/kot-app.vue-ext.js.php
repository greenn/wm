...
headers('js', 'utf8', 'nosniff', etag::ctx(
	...
	$js['provide/toggle-helpers'] = rb('vue', 'path', 'provide/state/toggle-helpers.js.inc'),
		//@toggleValue()

	$js['provide/set-fields'] = kot('ui', 'path', 'provide/set-fields.js.inc'),
	$js['provide/prm-fields'] = kot('ui', 'path', 'provide/prm-fields.js.inc'),
	__FILE__
), SITE_CACHE);
?>
...
<? include $js['provide/toggle-helpers']; ?>


<? include $js['provide/set-fields']; ?>

<? include $js['provide/prm-fields']; ?>