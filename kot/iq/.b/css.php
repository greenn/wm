...
$cssNamed = array(
	...
	//для lay-section
	'section-ps' => 20, //размер отступов внутри секций / расстояние между секциями
	'section-p' => 'section-ps', //'section-pv' => 'section-p', 'section-ph' => 'section-p',
	'section-cell-sep' => 'section-ps',
	'section-row-sep' => 'app-pv',

	'main-bg' => '#ededee',
	'section-bg' => '#f8f8fa', //white
	'section-bc' => '#f6f6f6',
	'section-br' => 18,
...
/*$ffs = array(
	'1' => array('JetBrains Mono', 'wght' => '300,400,500,700'),
	'2' => array('Roboto', 'wght' => '300,400,500,700'),
);*/
$ffs = array(
	'M' => array('Fira Code', 'wght' => '300,400,500,700'),
	'SS' => array('Fira Sans', 'wght' => '300,400,500,700'),
	'I' => array('Material Icons', 'wght' => ''),
	'IO' => array('Material Symbols Outlined', 'wght' => ''),
);
...
//$cssData['f1_'] = "{$cssData['f1']}, monospace";
