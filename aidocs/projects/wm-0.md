...
Этап `=5` реализован по уточнению владельца как
[blank2.wm в OpenServer](blank2.md). Ниже сохранён исходный план для `wm-0`;
путь `J:\dv\wm-0` не создавался. Для продолжения работы использовать карту blank2.
