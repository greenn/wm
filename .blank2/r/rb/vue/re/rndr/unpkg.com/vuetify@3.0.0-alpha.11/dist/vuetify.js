...
(function(global, factory) {
    ...
    function mounted$5(el, binding) {
        ...
        const observer = new IntersectionObserver((entries = [], observer) => {
            ...
            if (isIntersecting && modifiers.once) unmounted$5(el);
        ...
        setup(props, {
            ...
            return () => {
                ...
                return vue.withDirectives(vue.createVNode(Tag, {
                    ...
                    _: 1
                }, 8, ["type", "class", "style", "disabled", "href", "onClick"]), [
                    [vue.resolveDirective("ripple"), !props.disabled && props.ripple, null]
                ]);
            };
        }
        ...
        setup(props, {
            ...
            return () => {
                ...
                return isActive.value && vue.withDirectives(vue.createVNode(Tag, {
                    ...
                    _: 1
                }, 8, ["class", "style", "disabled", "draggable", "href", "onClick"]), [
                ...
                return vue.createVNode(vue.Fragment, null, [(_slots$activator = slots.activator) == null ? void 0 : _slots$activator.call(slots, {
                    ...
                    default: () => [hasContent.value && vue.createVNode("div", vue.mergeProps({
                        ...
                        default: () => [vue.withDirectives(vue.createVNode("div", {
                            ...
                            [vue.resolveDirective("click-outside"), {
    ...
    var VExpansionPanelTitle = defineComponent({
        ...
        setup(props, {
            ...
            return () => {
                ...
                }, null, 8, ["icon"])])], 14, ["tabindex", "disabled", "aria-expanded", "onClick"]), [
        ...
        setup(props, {
            ...
            return () => {
                ...
                return vue.createVNode(VExpandTransition, {
                    ...
                    }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)])], 512), [
                        [vue.vShow, expansionPanel.isSelected.value]
                    ])]
                }, 8, ["onAfterLeave"]);
            };
        }
                    ...
                    details: hasDetails && (() => {
                        ...
                        return vue.createVNode(vue.Fragment, null, [vue.createVNode(MaybeTransition, {
                            ...
                            default: () => [vue.withDirectives(vue.createVNode("div", {
                                ...
                                [vue.vShow, props.hint && (props.persistentHint || slotProps.value.isFocused)]
                            ])]
    ...
    var VPagination = defineComponent({
        ...
        setup(props, {
            ...
            const totalVisible = vue.computed(() => {
                ...
                if (props.totalVisible) return Math.min(parseInt((_props$totalVisible = props.totalVisible) != null ? _props$totalVisible : '', 10), length.value);
                ...
                return vue.createVNode(VField, vue.mergeProps({
                    ...
                    default: ({
                        ...
                        return vue.createVNode(vue.Fragment, null, [props.prefix && vue.createVNode("span", {
                            ...
                            "size": 1,
                            "type": props.type
                        }, slotProps, restAttrs), null, 16, ["onUpdate:modelValue", "autofocus", "disabled", "placeholder", "type"]), [
